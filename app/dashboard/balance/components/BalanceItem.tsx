...
export function BalanceItem({
  ...
  return (
    <div
      className="w-[150px] h-[300px] rounded-xl flex flex-col justify-end relative shadow-lg overflow-hidden cursor-pointer"
    ...
    >
      ...
      <div
        ...
        style={{ height: `${fillLevel}%`, backgroundColor: color }}
      >
        <svg
          viewBox="0 0 100 20"
